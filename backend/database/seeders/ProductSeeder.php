...
class ProductSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $catalog = [
            'Pizza' => [
                ['DIVA', 140.00, 'Une version moderne et gourmande de la Margherita, avec des bords genereusement garnis de ricotta cremeuse'],
                ['DIAVOLA 2.0', 165.00, 'Sauce tomate, mozzarella fior di latte, oignons rouges, spianata, olives et ndjua'],
                ["PUMP'N SPIN", 165.00, 'Creme de potiron, mozzarella fior di latte, scamorza, ndjua et pousses d epinards'],
                ['DEAR MARGHERITA', 130.00, 'Sauce tomate, mozzarella fior di latte, basilic et huile d olive EVO'],
                ['PARMA PAZZA', 205.00, 'Sauce tomate, mozzarella fior di latte, burratina, jambon cru de Parme 18 mois d affinage, roquette, copeaux de Grana Padano et basilic'],
                ['LA RUSTICA', 165.00, 'Mozzarella fior di latte, pommes de terre, cacio cavallo et salsiccia'],
            ],
            'Pasta' => [
                ['BOLO ROSSO', 150.00, 'Des tagliatelle nappees d une sauce bolognaise a la sauce tomate, riche en saveurs et pleine de douceur'],
                ['BOLO BIANCO', 165.00, 'Des tagliatelle nappees d une sauce bolognaise, sans tomate, riche en saveurs et pleine de douceur'],
                ['RED KISS', 150.00, 'Gnocchi moelleux et genereux, servi avec une sauce tomate parfumee, fondue a la mozzarella et gratine au parmesan'],
                ['ALLA VALENTINA', 260.00, 'Spaghetti alla chitarra al tartufo, prepares dans une meule de Pecorino DOP et truffe fraiche'],
                ['PISTACCHIO', 185.00, 'Mezze maniche au pesto de pistaches, stracciatella et pistaches croquantes'],
                ['GARFIELD', 175.00, 'Lasagnes revisitees facon carbo : guanciale croustillant, creme onctueuse, scamorza fumee et parmesan'],
            ],
            'Dolce Vita' => [
                ['PERFETTO', 110.00, 'Un dessert glace aux amandes, accompagne d un coulis de chocolat fondant'],
                ['KISS MY MOUSSE', 100.00, 'Une mousse au chocolat legere et gourmande, servie avec du crumble chocolat'],
                ['PISTACHIC', 100.00, 'Crumble a la ricotta sucree, creme de pistache et eclats de pistaches croquantes'],
                ['CLASSICO TIRAMISU', 100.00, 'L eternel tiramisu fatto con amore par La Squadra Gruppomimo'],
                ['TIRAMISU DE PIETRO', 100.00, 'Le tiramisu de Pietro, rempli d amour et de pistaches'],
            ],
            'Antipasti' => [
                ['GOLDEN BREAD', 75.00, 'Pizzetta doree au four, stracciatella fumee, tomates cerises, olives taggiasche, estragon et zeste de citron vert'],
                ['TRIO INFERNO', 150.00, '3 arancine : al tartufo, bolognese, cacio e pepe, sauce tomate et sauce Mimo'],
                ['FINGER MOOD', 110.00, 'Scamorza fumee panee et doree, croustillante a l exterieur, fondante a l interieur, servie avec une sauce tomate epicee maison'],
            ],
        ];
